...
public class Canvascript : MonoBehaviour
{
    ...
    public void Reiniciar(){
        RestaurarVides();
        GameManager.Instance.numberScore = GameManager.Instance.oldScore;
    ...
    public void NextLevel(){
        GameManager.Instance.nivell ++;
        GameManager.Instance.oldScore = GameManager.Instance.numberScore;
        GameManager.Instance.LoadScene($"Part{GameManager.Instance.nivell}Joc");
    }
